...
} from "./chunk-BGBUAW2R.js";
import {
  QueryClient,
  QueryClientProvider,
  img
} from "./chunk-RFOWWJTS.js";
import {
...
import {
  GuidedTourProvider,
  useGuidedTour
} from "./chunk-FE6GAT6B.js";
import {
  require_pick
} from "./chunk-473JD4F5.js";
import {
  useEnterprise
} from "./chunk-ZKUR2H2C.js";
import {
  Login
} from "./chunk-M4SS3PI5.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-7UFRKNQC.js";
import {
  ConfigurationProvider
} from "./chunk-YJFFVN4O.js";
import {
  require_baseMerge,
  require_createAssigner,
  require_merge,
  require_omit
} from "./chunk-M7TSYHYQ.js";
import {
  require_baseRest
} from "./chunk-VIF73T7X.js";
import {
  HistoryProvider
} from "./chunk-WJ4XKU2X.js";
import {
  errorsTrads
...
import {
  ...
  create4 as create2,
  create6 as create3
} from "./chunk-J44XKA6X.js";
import {
  TrackingProvider,
  useTracking
} from "./chunk-KLT5ZI3N.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-RXTYB4MY.js";
import {
  getBasename
} from "./chunk-QIJGNK42.js";
import {
  useClipboard
} from "./chunk-N7FPL3QB.js";
import {
  ADMIN_PERMISSIONS_EE,
  getEERoutes
} from "./chunk-Y7UX6BTM.js";
import {
  MemoizedInputRenderer
} from "./chunk-KRSMWZHU.js";
import {
  Form
} from "./chunk-I2HGMBNA.js";
import {
  Layouts
} from "./chunk-KC3SPHPT.js";
import {
  getByteSize
...
} from "./chunk-AGAWHDFM.js";
import {
  useTypedDispatch,
  useTypedSelector,
  useTypedStore
} from "./chunk-4EGKAWPD.js";
import {
  adminApi,
  getFetchClient,
  isBaseQueryError,
...
import {
  ...
  useNavigate,
  useRouteError
} from "./chunk-5CFX34I4.js";
import {
  ForwardRef$3,
  ForwardRef$3R,
  ForwardRef$5d
} from "./chunk-EFOSFDN7.js";
import {
  require_jsx_runtime
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-IS2YFLQV.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-WUISR4WW.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-N2OCIWSB.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-N5E7ZNLR.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-D466743A.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-YYGZBVSI.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-2FHMMTFO.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-D6SCGMLN.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-YEXFWCPH.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-TCA3HWHG.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-PUFO6KQT.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-IXZSC7DB.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-RZUWZWUA.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-EVWIF2F2.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-5VKGOOYP.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-Z7USCVYA.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-ANMLSFUY.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-XL2I3C3J.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-RP2PDNME.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-EXRCCVTD.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-HO62LQ7F.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-QA6XFEJR.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-EKXG7IK3.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-WSTB5SZ5.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-SU2X75Y3.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-4YAUHKMH.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-VYUSVJWY.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-6RA7NKKI.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-6HJNLYDR.js");
              return {
...
//# sourceMappingURL=chunk-RGJYC6CE.js.map
